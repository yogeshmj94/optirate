...
function AgreementContent() {
  ...
  const handleDigitalSign = async () => {
    ...
    try {
      // Send the data to our Next.js backend, which forwards it to Fineract
      ...
      alert("There was an error communicating with the banking core.");
      setIsSigning(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="bg-white p-12 rounded-2xl shadow-xl text-center max-w-lg w-full transform transition-all scale-100 animate-in fade-in zoom-in duration-500">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-4">Loan Disbursed!</h2>
          <p className="text-gray-600 mb-6">
            Your agreement with <strong>{lenderName}</strong> has been legally signed and recorded in the Fineract Master Ledger. Funds are being routed to your account.
          </p>
